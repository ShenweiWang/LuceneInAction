...
public class ScoreTest extends LiaTestCase {
	...
	public void testWildcard() throws Exception {
		indexSingleFieldDocs(new Field[] { Field.Text("contents", "wild"),
		...
		assertEquals("score the same", hits.score(0), hits.score(1), 0.0);
		assertEquals("score the same", hits.score(1), hits.score(2), 0.0);
	}
