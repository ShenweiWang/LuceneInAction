...
public class QueryParserTest extends LiaTestCase {
	...
	public void testToString() throws Exception {
		...
		query.add(new FuzzyQuery(new Term("field", "kountry")), true, false);
		query.add(new TermQuery(new Term("title", "western")), false, false);
	...
	public void testRangeQuery() throws Exception {
		Query query = QueryParser.parse("pubmonth:[200401 TO 200412]",
				"subject", analyzer);
	...
	public void testPhraseQuery() throws Exception {
		Query q = QueryParser.parse("\"This is Some Phrase*\"", "field",
