...
/**
 * Remove?? We don't show this anymore since SynonymAnalyzer demonstrates
 * placing more than one token in a position
 */
public class MetaphoneInjectionFilter extends TokenFilter {
	...
	public Token next() throws IOException {
		...
		if (save == null) {
			...
			save = new Token(value, t.startOffset(), t.endOffset(), METAPHONE);
