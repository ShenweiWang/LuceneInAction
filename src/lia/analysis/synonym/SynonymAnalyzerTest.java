...
public class SynonymAnalyzerTest extends TestCase {
	...
	public void testJumps() throws Exception {
		Token[] tokens = AnalyzerUtils.tokensFromAnalysis(synonymAnalyzer,
				"jumps");

		AnalyzerUtils.assertTokensEqual(tokens, new String[] { "jumps", "hops",
				"leaps" });
	...
	public void testWithQueryParser() throws Exception {
		Query query = QueryParser.parse("\"fox jumps\"", "content",
				synonymAnalyzer);
	...
	public static void main(String[] args) throws Exception {
		...
		AnalyzerUtils.displayTokens(synonymAnalyzer, "\"fox jumps\"");
	}
}
