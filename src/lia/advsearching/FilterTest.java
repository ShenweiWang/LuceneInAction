...
public class FilterTest extends LiaTestCase {
	...
	public void testDateFilter() throws Exception {
		...
		assertEquals("none modified in January", 0, hits.length());
	}
	...
	public void testQueryFilterWithRangeQuery() throws Exception {
		...
		Term start = new Term("modified", DateField.dateToString(jan1));
		Term end = new Term("modified", DateField.dateToString(dec31));
	...
	public void testCachingWrapper() throws Exception {
		...
		DateFilter dateFilter = new DateFilter("modified", jan1, dec31);
